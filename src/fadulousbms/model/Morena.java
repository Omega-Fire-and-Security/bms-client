...
/**
 * Created by ghost on 2017/04/11.
 */
/*
...
import fadulousbms.auxilary.ScanSession;
import fadulousbms.auxilary.SynchronousHelper;
...
public class Morena
{
    ...
    {
        deviceName="";
        //Morena example = new Morena();
        System.err.println("Morena... started at "+new Date());
...
//      Configuration.addDeviceType(".*fficejet.*", true);  // workaround for HP scanners
    ...
    public void simpleScan() throws Exception
    {
        ...
        { // for scanner device set the scanning parameters
            ...
            // ...
            ImageIO.write(bimage, "PNG", new File("out/scan.png"));
            System.out.println("Scanned and saved image to out/scan.png");
            Thread.sleep(30000);
        }
    }
