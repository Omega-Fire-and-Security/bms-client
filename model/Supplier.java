...
public class Supplier implements BusinessObject, Serializable
{
    ...
    public StringProperty registrationProperty(){return new SimpleStringProperty(getRegistration_number());}
    ...
    public StringProperty vatProperty(){return new SimpleStringProperty(getVat_number());}
